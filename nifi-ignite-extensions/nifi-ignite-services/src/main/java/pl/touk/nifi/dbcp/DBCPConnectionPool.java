...
import pl.touk.nifi.dbcp.DriverShim;
...
/**
 * This is an exact copy of NiFi's code except one modification:
 * - dynamicallyModifiesClasspath set to true for DB_DRIVER_LOCATION property
 * We need to use NiFi's dynamic classloading in order to load for IgniteJdbcDriver runtime dependency to ignite-spring.
 */
